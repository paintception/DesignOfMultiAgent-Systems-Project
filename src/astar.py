...
def path_find(map, width, height, start_pos, end_pos):
    """
    Find a path from start_pos to end_pos on map which has given width and height.
    """
    return _path_find(map, width, height, NUM_DIRECTIONS, _DIRS_X, _DIRS_Y,
            start_pos[0], start_pos[1], end_pos[0], end_pos[1])


# A-star algorithm.
# The path returned will be a string of digits of directions.
def _path_find(the_map, n, m, dirs, dx, dy, xA, yA, xB, yB):
